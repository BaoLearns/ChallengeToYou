...
QT_MOC_LITERAL(5, 60, 17) // "signalUpdateScore"

    },
    "CTYDb\0signalMatchSuccess\0\0signalMatchFail\0"
    "signalContestDone\0signalUpdateScore"
};
...
void CTYDb::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->signalUpdateScore((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (CTYDb::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CTYDb::signalUpdateScore)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void CTYDb::signalUpdateScore(const QString & _t1, const QString & _t2)
{
