...
public:
    ...
    void setupUi(QWidget *UserForm)
    {
        ...
        labelTotalScore = new QLabel(layoutWidget);
        ...
        pushButtonStartOrCancle = new QPushButton(layoutWidget);
